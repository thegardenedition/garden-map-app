...
// 세 색 모두 흰 아이콘 대비 4.4:1 이상이고 밝기(L*)를 45 안팎으로 맞춰 하나가 튀지 않는다.
// park가 예전엔 #0115A8이라 브랜드 딥블루(#06107D)와 거의 같아 배경에 묻혔다 — 한 단계 밝혔다.
export const GROUP_COLOR: Record<GroupId, string> = {
  company: "#B4603C", // 테라코타 — 사람이 하는 일(설계·시공·관리)
  material: "#2E7A50", // 딥그린 — 사고파는 물건(나무·잔디·석재)
  park: "#3A66B8", // 블루 — 가는 곳(장소)
};
